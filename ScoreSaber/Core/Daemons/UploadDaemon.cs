    ...
    internal class UploadDaemon : IDisposable, IUploadDaemon {
        ...
        public void ReplayHandler(string gameMode, IDifficultyBeatmap difficultyBeatmap, LevelCompletionResults results, bool practiceMode) {
            ...
            try {
                ...
                UploadStatusChanged?.Invoke(UploadStatus.Error, "OPENSOURCE XX Failed to upload score, error written to log. XX");
        ...
        public async Task UploadScore(ScoreSaberUploadData rawDataCasted, string data, IDifficultyBeatmap difficultyBeatmap, LevelCompletionResults results) {
            ...
            try {
                UploadStatusChanged?.Invoke(UploadStatus.Packaging, "OPENSOURCE XX Checking leaderboard ranked status... XX");
                ...
                bool failed = false;
                int attempts = 1;
                UploadStatusChanged?.Invoke(UploadStatus.Packaging, "OPENSOURCE XX Packaging replay... XX");
                ...
                if (serializedReplay != null) {
                    ...
                    UploadStatusChanged?.Invoke(UploadStatus.Error, "OPENSOURCE XX Failed to upload (failed to serialize replay) XX");
                    done = true;
                    failed = true;
                }
